...
class BertConfig(object):
    ...
    def __init__(self,
                ...
                full_pooler=False,
                num_context_ids=34): # this is for transformer-like BERT
        ...
        self.num_context_ids = num_context_ids 
...
class ContextBertModel(nn.Module):
    ...
    def __init__(self, config: BertConfig):
        ...
        num_context_ids = 34
        self.context_embeddings = nn.Embedding(config.num_context_ids, config.hidden_size)
